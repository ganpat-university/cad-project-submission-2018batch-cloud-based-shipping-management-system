...
PreparedStatement statement = con.prepareStatement("SELECT productID,pincode1,pincode2,servicetype,deliverytime,amount,status,productname,registerdate,deliverydate,shipmenttype,username,fullname,add1,add2,contact1,dfullname,dadd1,dadd2,contact2,payment FROM nondocument WHERE username=?");
...
<% 
Class.forName("com.mysql.cj.jdbc.Driver");
Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/courierservice","root","root");
...
try {
    ...
    message.setSubject("New Non Document Shipment");
    message.setText("New Non Document Shipment Entered");
    Transport.send(message);
